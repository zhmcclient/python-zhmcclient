...
"""
Example that lists permitted adapters across all managed CPCs.
"""
...
def main():
    ...
    try:
        ...
        print("Listing permitted adapters ...")
        try:
            ...
            return 1
        for ad in adapters:
            cpc = ad.manager.parent
            print(f"Adapter {ad.name} on CPC {cpc.name}")
