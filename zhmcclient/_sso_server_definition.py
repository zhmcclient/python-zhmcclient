...
"""
A :term:`SSO Server Definition` resource represents a definition that contains
information about an SSO server that may be used for HMC user authentication
purposes.The SSO server support is added by the single sign-on feature
"""
...
from ._utils import RC_SSO_SERVER_DEFINITION

__all__ = ['SSOServerDefinitionManager', 'SSOServerDefinition']


class SSOServerDefinitionManager(BaseManager):
    """
    Manager providing access to the :term:`SSO Server Definition` resources of
    a HMC.
    ...
    * :attr:`zhmcclient.Console.sso_server_definitions`
    ...
    * HMC version == 2.17.0
    ...
    def __init__(self, console):
        ...
        super().__init__(
            resource_class=SSOServerDefinition,
            class_name=RC_SSO_SERVER_DEFINITION,
            session=console.manager.session,
            parent=console,
            base_uri='/api/console/sso-server-definitions',
            oid_prop='element-id',
        ...
        * Task permission to the "Manage Single Sign-On Servers" task.
        ...
        Parameters:
          ...
          properties (dict): Initial property values.
            ...
            in section 'Create SSO Server Definition' in the :term:`HMC API`
            book.

        Returns:

          SSOServerDefinition:
            The resource object for the new SSO Server Definition.
        ...
        result = self.session.post(
            self.console.uri + '/sso-server-definitions', body=properties)
        ...
        sso_server_definition = SSOServerDefinition(self, uri, name, props)
        self._name_uri_cache.update(name, uri)
        return sso_server_definition


class SSOServerDefinition(BaseResource):
    """
    Representation of a :term:`SSO Server Definition`.
    ...
    (in this case, :class:`~zhmcclient.SSOServerDefinitionManager`).
    ...
    * HMC version == 2.17.0
    ...
    def __init__(self, manager, uri, name=None, properties=None):
        # This function should not go into the docs.
        #   manager (:class:`~zhmcclient.SSOServerDefinitionManager`):
        ...
        #     empty.
        assert isinstance(manager, SSOServerDefinitionManager), (
            "Console init: Expected manager type "
            f"{SSOServerDefinitionManager}, got {type(manager)}")
        super().__init__(
    ...
    def delete(self):
        """
        Delete this SSO Server Definition.
        ...
        * Task permission to the "Manage Single Sign-On Servers" task.
        ...
        Parameters:
          ...
          properties (dict): New values for the properties to be updated.
            ...
            section 'Data model' in section 'SSO Server Definition object' in
