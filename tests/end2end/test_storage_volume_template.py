...
def test_stovoltpl_find_list(zhmc_logger, dpm_mode_cpcs):
    """
...
def test_stovoltpl_property(zhmc_logger, dpm_mode_cpcs):
    """
...
def test_stovoltpl_crud(zhmc_logger, dpm_mode_cpcs):
    """
