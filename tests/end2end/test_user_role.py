...
def test_urole_find_list(zhmc_logger, hmc_session):
    """
    ...
    if not urole_list:
        skip_log(zhmc_logger,
                 f"No user roles defined on HMC {hd.host}")
...
def test_urole_property(zhmc_logger, hmc_session):
    """
...
def test_urole_crud(zhmc_logger, hmc_session):
    """
