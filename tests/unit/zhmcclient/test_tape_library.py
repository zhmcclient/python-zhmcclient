...
class TestTapeLibrary:
    ...
    def test_tape_lib_manager_requestzoning(
            self, caplog, input_props, fcp_availability, exp_exc):
        """Test TapeLibraryManager.discover_tape_libraries()."""
        ...
        if exp_exc is not None:
            ...
            with pytest.raises(exp_exc.__class__) as exc_info:
                ...
                tape_lib_mgr.request_tape_library_zoning(input_props)
    ...
    def test_tape_lib_manager_discovertl(
        ...
        if exp_exc is not None:
            ...
            with pytest.raises(exp_exc.__class__) as exc_info:
                ...
                # Execute the code to be tested
                tape_lib_mgr.discover_tape_libraries(input_props)
    ...
    def test_tape_lib_undefine_tape_library(self, input_props, exp_exc):
        """Test TapeLibrary.undefine_tape_library()."""
        ...
        if exp_exc is not None:
            ...
            with pytest.raises(exp_exc.__class__) as exc_info:
                ...
                # Execute the code to be tested
                tape_lib.undefine_tape_library()
